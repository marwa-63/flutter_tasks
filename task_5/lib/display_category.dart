...
class DisplayCategory extends StatelessWidget {
  ...
  final double price;
   ...
   DisplayCategory({super.key, required this.category, required this.price});
  ...
  Widget build(BuildContext context) {
    ...
    final List filteredProducts = products.where((product) {
                  ...
                  onTap: () {
                    ...
                    builder: (context){
                      return Padding(
                        ...
                        child: Center(child: Text("${filteredProducts[index]["description"]}",style: TextStyle(),)),
                      );
                    },
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          width: 100,
                          height: 100,
                          child:Image.asset(filteredProducts[index]["photo"] , fit:BoxFit.contain)
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            Icon(filteredProducts[index]["rating"] >=1 ? Icons.star :Icons.star_half,color:Colors.amber),
                  
                            // second star cases //
                            if(filteredProducts[index]["rating"] ==1)
                            Icon(Icons.star_border_outlined,color:Colors.amber)
                            else if(filteredProducts[index]["rating"] ==1.5)
                            ...
                            Icon(Icons.star,color:Colors.amber)
                             ,
                              ...
                              // third star cases //
                            if(filteredProducts[index]["rating"] <=2)
                            Icon(Icons.star_border_outlined,color:Colors.amber)
                            else if(filteredProducts[index]["rating"] ==2.5)
                            Icon(Icons.star_half,color:Colors.amber)
                            else
                            Icon(Icons.star,color:Colors.amber),
                  
                            // fourth star cases //
                            if(filteredProducts[index]["rating"] <=3)
                            Icon(Icons.star_border_outlined,color:Colors.amber)
                            else if(filteredProducts[index]["rating"] ==3.5)
                            Icon(Icons.star_half,color:Colors.amber)
                            else
                            Icon(Icons.star,color:Colors.amber),
                  
                            // fifth star cases //
                            if(filteredProducts[index]["rating"] <=4)
                            Icon(Icons.star_border_outlined,color:Colors.amber)
                            else if(filteredProducts[index]["rating"] ==4.5)
                            Icon(Icons.star_half,color:Colors.amber)
                            else
                            Icon(Icons.star,color:Colors.amber),
